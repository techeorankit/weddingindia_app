...
enum _ProfileMenuAction { privacy, terms, help, logout }
...
class _MatchesScreenState extends State<MatchesScreen> {
  ...
  void _handleMenuAction(_ProfileMenuAction action) {
    switch (action) {
      case _ProfileMenuAction.privacy:
        _showInfoDialog(
          'Privacy Policy',
          'We respect your privacy and keep your personal information secure. '
          'Your profile information is used only to provide the Wedding India '
          'matrimony service.',
        );
        break;
      case _ProfileMenuAction.terms:
        _showInfoDialog(
          'Terms & Conditions',
          'By using Wedding India, you agree to provide accurate information, '
          'respect other members, and use the service only for lawful purposes.',
        );
        break;
      case _ProfileMenuAction.help:
        _showInfoDialog(
          'Help Line',
          'For help, please contact us at support@weddingindia.com.',
        );
        break;
  ...
  Future<void> _handleAction(int toUserId, String type) async {
                  ...
                  Row(
                    ...
                    children: [
                      _actionBtn(Icons.send, 'Interest',
                          active.contains('interest') ? const Color(0xFFE91E63) : const Color(0xFF8B1A2E),
                          Colors.white, () => _handleAction(userId, 'interest')),
                      _actionBtn(Icons.star_border, 'Shortlist',
                          active.contains('shortlist') ? Colors.amber : Colors.white24,
                          Colors.white, () => _handleAction(userId, 'shortlist')),
                      _actionBtn(Icons.close, 'Ignore',
                          active.contains('ignore') ? Colors.red : Colors.white24,
                          Colors.white, () => _handleAction(userId, 'ignore')),
                      _actionBtn(Icons.chat_bubble_outline, 'Chat',
                          active.contains('chat') ? Colors.green : Colors.white24,
                          Colors.white, () async {
                            await _handleAction(userId, 'chat');
                            if (mounted) {
